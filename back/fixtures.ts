...
const run = async () => {
  ...
  const [Beyonce, Shakira, Ciara] = await Artist.create(
    {
      title: 'Beyonce',
      description: 'She is a diva',
      image: 'fixtures/beyonce.png',
      user: user1._id,
      isPublished: false,
    },
    {
      title: 'Shakira',
      description: 'Best dancer ever',
      image: 'fixtures/shakira.png',
      user: admin._id,
      isPublished: false,
    },
    {
      title: 'Ciara',
      description: 'Old school girl',
      image: 'fixtures/ciara.jpeg',
      user: user1._id,
      isPublished: false,
    },
  );

  const [Renaissance, Lemonade, SheWolf, ShakiraAlbum, Goddies, Evolution] = await Album.create(
    {
      artist: Beyonce._id,
      title: 'Renaissance',
      year: 2022,
      image: 'fixtures/renaissance.png',
      user: user1._id,
      isPublished: false,
    },
    {
    ...
    },
    {
      ...
      title: 'ShakiraAlbum',
      year: 2014,
      image: 'fixtures/shakira_album.png',
      user: admin._id,
      isPublished: false,
    },
    {
