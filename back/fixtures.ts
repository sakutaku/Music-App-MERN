...
const run = async () => {
    ...
    const [
        ...
        {album: Renaissance._id, title: "I'm That Girl", number: 1, duration: '3:28'},
        {album: Renaissance._id, title: 'Cozy', number: 2, duration: '3:30'},
        {album: Renaissance._id, title: 'Alien Superstar', number: 3, duration: '3:35'},
        {album: Renaissance._id, title: 'Cuff It', number: 4, duration: '3:45'},
        {album: Renaissance._id, title: 'Energy', number: 5, duration: '1:56'},

        {album: Lemonade._id, title: "Pray You Catch me", number: 1, duration: '3:16'},
        {album: Lemonade._id, title: 'Hold Up', number: 2, duration: '3:41'},
        {album: Lemonade._id, title: "Don't Hurt Yourself", number: 3, duration: '3:53'},
        {album: Lemonade._id, title: 'Sorry', number: 4, duration: '3:52'},
        {album: Lemonade._id, title: '6 Inch', number: 5, duration: '4:20'},

        {album: SheWolf._id, title: 'She Wolf', number: 1, duration: '3:10'},
        {album: SheWolf._id, title: 'Did it Again', number: 2, duration: '3:13'},
        {album: SheWolf._id, title: 'Long Time', number: 3, duration: '2:56'},
        {album: SheWolf._id, title: 'Why Wait', number: 4, duration: '2:43'},
        {album: SheWolf._id, title: 'Good Stuff', number: 5, duration: '3:18'},

        {album: ShakiraAlbum._id, title: "Can't Remember to Forget You", number: 1, duration: '3:26'},
        {album: ShakiraAlbum._id, title: 'Empire', number: 2, duration: '4:03'},
        {album: ShakiraAlbum._id, title: "You Don't Care About Me", number: 3, duration: '3:42'},
        {album: ShakiraAlbum._id, title: 'Dare', number: 4, duration: '3:08'},
        {album: ShakiraAlbum._id, title: 'Cut me Deep', number: 5, duration: '3:15'},
    );
